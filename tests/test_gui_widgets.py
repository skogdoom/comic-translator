...
def test_the_cleanup_leaves_a_completer_popup_to_the_combo_that_owns_it(
    ...
    The test above is the first to open a completer popup, and it took the
    suite down with a segmentation fault three runs in four — in a later
    test, whichever first ran an event loop. The popup has no parent, so
